...
# 145 "./mcc_generated_files/adcc.h"
void ADCC_Initialize(void);
# 174 "./mcc_generated_files/adcc.h"
void ADCC_StartConversion(adcc_channel_t channel);
# 204 "./mcc_generated_files/adcc.h"
_Bool ADCC_IsConversionDone(void);
# 236 "./mcc_generated_files/adcc.h"
adc_result_t ADCC_GetConversionResult(void);
# 267 "./mcc_generated_files/adcc.h"
adc_result_t ADCC_GetSingleConversion(adcc_channel_t channel);
# 292 "./mcc_generated_files/adcc.h"
void ADCC_StopConversion(void);
# 319 "./mcc_generated_files/adcc.h"
void ADCC_SetStopOnInterrupt(void);
# 344 "./mcc_generated_files/adcc.h"
void ADCC_DischargeSampleCapacitor(void);
# 370 "./mcc_generated_files/adcc.h"
void ADCC_LoadAcquisitionRegister(uint8_t);
# 396 "./mcc_generated_files/adcc.h"
void ADCC_SetPrechargeTime(uint8_t);
# 421 "./mcc_generated_files/adcc.h"
void ADCC_SetRepeatCount(uint8_t);
# 449 "./mcc_generated_files/adcc.h"
uint8_t ADCC_GetCurrentCountofConversions(void);
# 473 "./mcc_generated_files/adcc.h"
void ADCC_ClearAccumulator(void);
# 498 "./mcc_generated_files/adcc.h"
uint16_t ADCC_GetAccumulatorValue(void);
# 526 "./mcc_generated_files/adcc.h"
_Bool ADCC_HasAccumulatorOverflowed(void);
# 551 "./mcc_generated_files/adcc.h"
uint16_t ADCC_GetFilterValue(void);
# 579 "./mcc_generated_files/adcc.h"
uint16_t ADCC_GetPreviousResult(void);
# 605 "./mcc_generated_files/adcc.h"
void ADCC_DefineSetPoint(uint16_t);
# 631 "./mcc_generated_files/adcc.h"
void ADCC_SetUpperThreshold(uint16_t);
# 657 "./mcc_generated_files/adcc.h"
void ADCC_SetLowerThreshold(uint16_t);
# 684 "./mcc_generated_files/adcc.h"
uint16_t ADCC_GetErrorCalculation(void);
# 711 "./mcc_generated_files/adcc.h"
void ADCC_EnableDoubleSampling(void);
# 735 "./mcc_generated_files/adcc.h"
void ADCC_EnableContinuousConversion(void);
# 759 "./mcc_generated_files/adcc.h"
void ADCC_DisableContinuousConversion(void);
# 787 "./mcc_generated_files/adcc.h"
_Bool ADCC_HasErrorCrossedUpperThreshold(void);
# 815 "./mcc_generated_files/adcc.h"
