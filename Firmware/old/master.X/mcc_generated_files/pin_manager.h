...
*/
#define NA_RA4_SetHigh()          LATAbits.LATA4 = 1
/**
  @Summary
...
*/
#define NA_RA4_SetLow()           LATAbits.LATA4 = 0
/**
  @Summary
...
*/
#define NA_RA4_Toggle()           LATAbits.LATA4 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RA4
    postValue = NA_RA4_GetValue();
    </code>

*/
#define NA_RA4_GetValue()         PORTAbits.RA4
/**
  @Summary
  ...
  @Example
    ...
    NA_RA4_SetDigitalInput();
    </code>

*/
#define NA_RA4_SetDigitalInput()  TRISAbits.TRISA4 = 1
/**
  @Summary
  ...
  @Example
    ...
    NA_RA4_SetDigitalOutput();
    </code>

*/
#define NA_RA4_SetDigitalOutput() TRISAbits.TRISA4 = 0
/**
  @Summary
...
*/
#define channel_AN2_SetHigh()          LATBbits.LATB0 = 1
/**
  @Summary
...
*/
#define channel_AN2_SetLow()           LATBbits.LATB0 = 0
/**
  @Summary
...
*/
#define channel_AN2_Toggle()           LATBbits.LATB0 ^= 1
/**
  @Summary
...
*/
#define channel_AN2_SetDigitalInput()  TRISBbits.TRISB0 = 1
/**
  @Summary
...
*/
#define channel_AN2_SetDigitalOutput() TRISBbits.TRISB0 = 0
/**
  @Summary
...
*/
#define channel_AN3_SetHigh()          LATBbits.LATB1 = 1
/**
  @Summary
...
*/
#define channel_AN3_SetLow()           LATBbits.LATB1 = 0
/**
  @Summary
...
*/
#define channel_AN3_Toggle()           LATBbits.LATB1 ^= 1
/**
  @Summary
...
*/
#define channel_AN3_SetDigitalInput()  TRISBbits.TRISB1 = 1
/**
  @Summary
...
*/
#define channel_AN3_SetDigitalOutput() TRISBbits.TRISB1 = 0
/**
  @Summary
...
*/
#define channel_AN11_SetHigh()          LATBbits.LATB13 = 1
/**
  @Summary
...
*/
#define channel_AN11_SetLow()           LATBbits.LATB13 = 0
/**
  @Summary
...
*/
#define channel_AN11_Toggle()           LATBbits.LATB13 ^= 1
/**
  @Summary
...
*/
#define channel_AN11_GetValue()         PORTBbits.RB13
/**
  @Summary
...
*/
#define channel_AN11_SetDigitalInput()  TRISBbits.TRISB13 = 1
/**
  @Summary
...
*/
#define channel_AN11_SetDigitalOutput() TRISBbits.TRISB13 = 0
/**
  @Summary
...
*/
#define NA_RB5_SetHigh()          LATBbits.LATB5 = 1
/**
  @Summary
...
*/
#define NA_RB5_SetLow()           LATBbits.LATB5 = 0
/**
  @Summary
...
*/
#define NA_RB5_Toggle()           LATBbits.LATB5 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RB5
    postValue = NA_RB5_GetValue();
    </code>

*/
#define NA_RB5_GetValue()         PORTBbits.RB5
/**
  @Summary
  ...
  @Example
    ...
    NA_RB5_SetDigitalInput();
    </code>

*/
#define NA_RB5_SetDigitalInput()  TRISBbits.TRISB5 = 1
/**
  @Summary
  ...
  @Example
    ...
    NA_RB5_SetDigitalOutput();
    </code>

*/
#define NA_RB5_SetDigitalOutput() TRISBbits.TRISB5 = 0
