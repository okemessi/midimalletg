...
void main(void)
{
    unsigned int scan_max[18]={0};
    unsigned int scan_max_prev[18]={0};
    unsigned int i = 0;
    union
    {
    ...
    while (1)
    {
        ...
        max_with_threshold(&scan_max[14], IOvalue[1][PORTBbits.RB5]);
        max_with_threshold(&scan_max[15], IOvalue[2][PORTBbits.RB6]);
        max_with_threshold(&scan_max[16], IOvalue[3][PORTBbits.RB0]);
        max_with_threshold(&scan_max[17], IOvalue[4][PORTBbits.RB1]);
