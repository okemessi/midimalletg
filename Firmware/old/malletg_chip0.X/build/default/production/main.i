...
void LED_increment(uint8_t buffer[3]){
  ...
  LATAbits.LATA0 = buffer[i] & 1;
  LATAbits.LATA1 = (buffer[i]>>1) & 1;
  LATAbits.LATA2 = (buffer[i]>>2) & 1;
  LATAbits.LATA3 = (buffer[i]>>3) & 1;
  LATAbits.LATA4 = (buffer[i]>>4) & 1;
  LATAbits.LATA5 = (buffer[i]>>5) & 1;
  LATAbits.LATA6 = (buffer[i]>>6) & 1;
}
