...
# 143 "./mcc_generated_files/adcc.h"
void ADCC_Initialize(void);
# 172 "./mcc_generated_files/adcc.h"
void ADCC_StartConversion(adcc_channel_t channel);
# 202 "./mcc_generated_files/adcc.h"
_Bool ADCC_IsConversionDone(void);
# 234 "./mcc_generated_files/adcc.h"
adc_result_t ADCC_GetConversionResult(void);
# 265 "./mcc_generated_files/adcc.h"
adc_result_t ADCC_GetSingleConversion(adcc_channel_t channel);
# 290 "./mcc_generated_files/adcc.h"
void ADCC_StopConversion(void);
# 317 "./mcc_generated_files/adcc.h"
void ADCC_SetStopOnInterrupt(void);
# 342 "./mcc_generated_files/adcc.h"
void ADCC_DischargeSampleCapacitor(void);
# 368 "./mcc_generated_files/adcc.h"
void ADCC_LoadAcquisitionRegister(uint8_t);
# 394 "./mcc_generated_files/adcc.h"
void ADCC_SetPrechargeTime(uint8_t);
# 419 "./mcc_generated_files/adcc.h"
void ADCC_SetRepeatCount(uint8_t);
# 447 "./mcc_generated_files/adcc.h"
uint8_t ADCC_GetCurrentCountofConversions(void);
# 471 "./mcc_generated_files/adcc.h"
void ADCC_ClearAccumulator(void);
# 496 "./mcc_generated_files/adcc.h"
uint16_t ADCC_GetAccumulatorValue(void);
# 524 "./mcc_generated_files/adcc.h"
_Bool ADCC_HasAccumulatorOverflowed(void);
# 549 "./mcc_generated_files/adcc.h"
uint16_t ADCC_GetFilterValue(void);
# 577 "./mcc_generated_files/adcc.h"
uint16_t ADCC_GetPreviousResult(void);
# 603 "./mcc_generated_files/adcc.h"
void ADCC_DefineSetPoint(uint16_t);
# 629 "./mcc_generated_files/adcc.h"
void ADCC_SetUpperThreshold(uint16_t);
# 655 "./mcc_generated_files/adcc.h"
void ADCC_SetLowerThreshold(uint16_t);
# 682 "./mcc_generated_files/adcc.h"
uint16_t ADCC_GetErrorCalculation(void);
# 709 "./mcc_generated_files/adcc.h"
void ADCC_EnableDoubleSampling(void);
# 733 "./mcc_generated_files/adcc.h"
void ADCC_EnableContinuousConversion(void);
# 757 "./mcc_generated_files/adcc.h"
void ADCC_DisableContinuousConversion(void);
# 785 "./mcc_generated_files/adcc.h"
_Bool ADCC_HasErrorCrossedUpperThreshold(void);
# 813 "./mcc_generated_files/adcc.h"
...
void main(void)
{
    unsigned int scan_max[17]={0};
    unsigned int scan_max_prev[17]={0};
    unsigned int i = 0;
    union
    {
...
static void max_with_threshold(unsigned int *scan_max, unsigned int scan_buffer){
  if (*scan_max < scan_buffer && scan_buffer >= 4)
  {
