...
*/
#define IO_USBDp_SetHigh()          LATBbits.LATB10 = 1
/**
  @Summary
...
*/
#define IO_USBDp_SetLow()           LATBbits.LATB10 = 0
/**
  @Summary
...
*/
#define IO_USBDp_Toggle()           LATBbits.LATB10 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RB10
    postValue = IO_USBDp_GetValue();
    </code>

*/
#define IO_USBDp_GetValue()         PORTBbits.RB10
/**
  @Summary
  ...
  @Example
    ...
    IO_USBDp_SetDigitalInput();
    </code>

*/
#define IO_USBDp_SetDigitalInput()  TRISBbits.TRISB10 = 1
/**
  @Summary
  ...
  @Example
    ...
    IO_USBDp_SetDigitalOutput();
    </code>

*/
#define IO_USBDp_SetDigitalOutput() TRISBbits.TRISB10 = 0
/**
  @Summary
...
*/
#define IO_USBDn_SetHigh()          LATBbits.LATB11 = 1
/**
  @Summary
...
*/
#define IO_USBDn_SetLow()           LATBbits.LATB11 = 0
/**
  @Summary
...
*/
#define IO_USBDn_Toggle()           LATBbits.LATB11 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RB11
    postValue = IO_USBDn_GetValue();
    </code>

*/
#define IO_USBDn_GetValue()         PORTBbits.RB11
/**
  @Summary
  ...
  @Example
    ...
    IO_USBDn_SetDigitalInput();
    </code>

*/
#define IO_USBDn_SetDigitalInput()  TRISBbits.TRISB11 = 1
/**
  @Summary
  ...
  @Example
    ...
    IO_USBDn_SetDigitalOutput();
    </code>

*/
#define IO_USBDn_SetDigitalOutput() TRISBbits.TRISB11 = 0
/**
  @Summary
...
*/
#define IO_USBbuson_SetHigh()          LATBbits.LATB14 = 1
/**
  @Summary
...
*/
#define IO_USBbuson_SetLow()           LATBbits.LATB14 = 0
/**
  @Summary
...
*/
#define IO_USBbuson_Toggle()           LATBbits.LATB14 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RB14
    postValue = IO_USBbuson_GetValue();
    </code>

*/
#define IO_USBbuson_GetValue()         PORTBbits.RB14
/**
  @Summary
  ...
  @Example
    ...
    IO_USBbuson_SetDigitalInput();
    </code>

*/
#define IO_USBbuson_SetDigitalInput()  TRISBbits.TRISB14 = 1
/**
  @Summary
  ...
  @Example
    ...
    IO_USBbuson_SetDigitalOutput();
    </code>

*/
#define IO_USBbuson_SetDigitalOutput() TRISBbits.TRISB14 = 0
/**
  @Summary
...
*/
#define IO_U2DE_SetHigh()          LATBbits.LATB4 = 1
/**
  @Summary
...
*/
#define IO_U2DE_SetLow()           LATBbits.LATB4 = 0
/**
  @Summary
...
*/
#define IO_U2DE_Toggle()           LATBbits.LATB4 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RB4
    postValue = IO_U2DE_GetValue();
    </code>

*/
#define IO_U2DE_GetValue()         PORTBbits.RB4
/**
  @Summary
  ...
  @Example
    ...
    IO_U2DE_SetDigitalInput();
    </code>

*/
#define IO_U2DE_SetDigitalInput()  TRISBbits.TRISB4 = 1
/**
  @Summary
  ...
  @Example
    ...
    IO_U2DE_SetDigitalOutput();
    </code>

*/
#define IO_U2DE_SetDigitalOutput() TRISBbits.TRISB4 = 0
/**
  @Summary
...
/**
  @Summary
    Configures the pin settings of the PIC32MX210F016B
    The peripheral pin select, PPS, configuration is also handled by this manager.
